...
X_train, X_test, y_train, y_test = train_test_split(learningFeatures_scaled, learning_labels, test_size=0.2, random_state=42)
...
grid.fit(X_train, learningLabelsStd), 
...
grid.best_estimator_.fit(X_train, learningLabelsStd)
